...
class ControlPanel:
    ...
    def __init__(
        ...
        Args:
            ...
            on_process_callback: Function called when process button is clicked
    ...
    def _build_process_button(self):
        """Build the process button section."""
        self.process_frame = ttk.Frame(self.frame)
        self.process_frame.pack(fill='x', pady=(10, 0))
    ...
    def _on_process_click(self):
        ...
        # Call the processing callback with settings
        self.on_process_callback(self.get_current_settings())
